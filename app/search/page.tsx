...
export default async function SearchPage({
  ...
  try {
    const HourlyDataRequest: HourlyForecastResponse = await getHourlyData(lat, lon);
    const TenDayForecastRequest: TenDayForecastData = await getTenDayForecast(lat, lon);
    const AirDataRequest: AirPollutionResponse = await getAirPollutionData(lat, lon);
